...
export const UI_TEXT = {
    ...
    auth: {
        ...
        recoveryConfirmTitle: 'Recuperación de contraseña',
        recoveryConfirmDesc: 'Por seguridad, confirma que fuiste tú quien solicitó el cambio. Pulsa el botón para continuar.',
        recoveryConfirmBtn: 'Continuar con el cambio',
        recoveryConfirmLoading: '<i class="fas fa-circle-notch animate-spin"></i> Verificando enlace...',
